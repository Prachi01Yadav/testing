...
def base_tree_files(base_ref: str, rootdir: str) -> set[str] | None:
...
def template_stem_for(filename: str) -> str | None:
...
def list_git_files(rootdir: str) -> list[str] | None:
...
def collect_files(rootdir: str, filenames: list[str] | None) -> list[str] | None:
...
def print_remediation(failed: list[tuple[str, str | None]]) -> None:
